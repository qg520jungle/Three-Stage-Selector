	...
	$.fn.formCheck = function(options) {
		return this.each(function(index, el) {
			...
			function showResult() {
				if (resultBool) {
					$('.v-msg').hide();
					//$('.v-msg .cc').html($(This).attr('data-xg-msg'));
			...
			*/
			 ...
			 *
			 * */
			function easypswConfir(s) {
				s += '';
				var password = refSelf ? refSelf : /[0-9a-zA-Z!@#$%^&*.,;'"/?+=-]{6,32}/;
				if (s) {
					isEmpty = false;
					return s.match(password) ? true : false;
				} else {
